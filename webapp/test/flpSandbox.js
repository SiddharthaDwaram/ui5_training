		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World",
									"targetURL": "#comsapui5training-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapui5training-display": {
								"semanticObject": "comsapui5training",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.ui5training",
									"url": sap.ui.require.toUrl("com/sap/ui5training")
								}
							}
						}
					}
